    ...
    return (
        <div className='min-h-screen flex flex-col gap-10 p-10 text-lg'>
            ...
            <div className="flex flex-wrap gap-8 justify-center my-auto">
                <div className="card card-compact cursor-pointer w-96 bg-base-200 hover:bg-info hover:text-black shadow-xl" onClick={() => navigate('/taskboard')}>
                    <div className="card-body">
                        <h2 className="card-title">Tasks</h2>
                        <p>Manage tasks, set due dates, add costs and automatically charge the budget on completion.</p>
                    </div>
                </div>
                <div className="card card-compact cursor-pointer w-96 bg-base-200 hover:bg-info hover:text-black shadow-xl" onClick={() => navigate('/noticeboard')}>
                    <div className="card-body">
                        <h2 className="card-title">Notices</h2>
                        <p>Post to the building notice board, comment on posts and upload images.</p>
                    </div>
                </div>
                <div className="card card-compact cursor-pointer w-96 bg-base-200 hover:bg-info hover:text-black shadow-xl" onClick={() => navigate('/budget')}>
                    <div className="card-body">
                        <h2 className="card-title">Budgeting</h2>
                        <p>Create budgets and add transactions, or link tasks to transactions</p>
                    </div>
                </div>
                <div className="card card-compact cursor-pointer w-96 bg-base-200 hover:bg-info hover:text-black shadow-xl" onClick={() => navigate('/contacts')}>
                    <div className="card-body">
                ...
                <div className="card card-compact cursor-pointer w-96 bg-base-200 hover:bg-info hover:text-black shadow-xl" onClick={() => navigate('/meetings')}>
                    <div className="card-body">
